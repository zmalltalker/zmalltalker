...
- **Live preview** — Toggle between a monospaced editor and a beautifully rendered HTML view with a single keystroke.
...
│   ├── MarkdownEditorView.swift    # Plain TextEditor, monospaced font
